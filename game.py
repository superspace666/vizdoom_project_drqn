...
RESOURCES_DIR = "E:\\pycharm_project\\vizdoom_project\\resources"#os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(__file__))), 'resources')
...
ENEMY_NAME_SET = {'MarineBFG', 'MarineBerserk', 'MarineChaingun', 'MarineChainsaw', 'MarineFist', 'MarinePistol',
                  'MarinePlasma', 'MarineRailgun', 'MarineRocket', 'MarineSSG', 'MarineShotgun', 'Demon'}
HEALTH_ITEM_NAME_SET = {'ArmorBonus', 'BlueArmor', 'GreenArmor', 'HealthBonus', 'Medikit', 'Stimpack'}
WEAPON_NAME_SET = {'Pistol', 'Chaingun', 'RocketLauncher', 'Shotgun', 'SuperShotgun', 'PlasmaRifle', 'BFG9000',
                   'Chainsaw'}
AMMO_NAME_SET = {'Cell', 'CellPack', 'Clip', 'ClipBox', 'RocketAmmo', 'RocketBox', 'Shell', 'ShellBox'}
...
class Game(object):
    ...
    def __init__(
            ...
            freelook=False, name='main', color=0,
            visible=False,
        ...
        self.scenario_path = os.path.join(RESOURCES_DIR, 'scenarios', 'defend_the_center.wad')
        ...
        for weapon_name, weapon_ammo, weapon_id in WEAPONS_PREFERENCES:
            ...
            if self.properties[weapon_name] > 0 and self.properties[weapon_ammo] >= min_ammo:
                if self.properties['sel_weapon'] != weapon_id:
                    ...
                    self.log(
                        "Manual weapon change: %s -> %s" % (WEAPON_NAMES[self.properties['sel_weapon']], weapon_name))
                break
